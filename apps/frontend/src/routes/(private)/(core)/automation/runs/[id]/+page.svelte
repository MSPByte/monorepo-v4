<script lang="ts">
  ...
  import StepNode, {
    type StepStatus,
  } from '$lib/components/domain/step-node.svelte';
  ...
  <div class="flex-1 overflow-auto">
    <div class="flex flex-col gap-8 p-6">
      ...
      {:else}
        ...
        {@const snapshot = run.packageSnapshot as { name?: string; steps?: Array<{ label?: string; capabilityId: string }> }}
            ...
            <div class={isLast ? 'pb-2' : 'pb-6'}>
              <div class="rounded-lg border bg-card p-4">
                ...
                {#if step.errorMessage}
                  <div class="mt-3 rounded-md border border-rose-500/30 bg-rose-500/5 p-3 text-sm">
